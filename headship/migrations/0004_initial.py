...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Headship'
        db.create_table('headship_headship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('last_name_ru', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('patronymic_ru', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('patronymic_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal('headship', ['Headship'])


    def backwards(self, orm):
        # Deleting model 'Headship'
        db.delete_table('headship_headship')
