...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Headship.subpost'
        db.add_column('headship_headship', 'subpost',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Headship.biopic'
        db.add_column('headship_headship', 'biopic',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Headship.show_biopic'
        db.add_column('headship_headship', 'show_biopic',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Headship.subpost'
        db.delete_column('headship_headship', 'subpost')

        # Deleting field 'Headship.biopic'
        db.delete_column('headship_headship', 'biopic')

        # Deleting field 'Headship.show_biopic'
        db.delete_column('headship_headship', 'show_biopic')
