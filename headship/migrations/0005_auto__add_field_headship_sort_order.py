...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Headship.sort_order'
        db.add_column('headship_headship', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Headship.sort_order'
        db.delete_column('headship_headship', 'sort_order')
