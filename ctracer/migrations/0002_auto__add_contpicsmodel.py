...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContPicsModel'
        db.create_table('cmsplugin_contpicsmodel', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('ctracer', ['ContPicsModel'])


    def backwards(self, orm):
        # Deleting model 'ContPicsModel'
        db.delete_table('cmsplugin_contpicsmodel')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 2, 0, 0)'}),
