$MAIN:menu[^table::sql{select id, menu_title, menu_uri, visible, menu_parent_id from ${MAIN:sql_config.table_prefix}menu where menu_id = '1' and menu_parent_id = '0' order by order_by ASC}]
^if($MAIN:menu){
#<ul>
