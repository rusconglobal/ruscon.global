...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MenuImage'
        db.create_table('cms_helper_menuimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sitetree.TreeItem'])),
        ...
        db.send_create_signal('cms_helper', ['MenuImage'])


    def backwards(self, orm):
        # Deleting model 'MenuImage'
        db.delete_table('cms_helper_menuimage')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cms_helper.clocktown': {
            'Meta': {'ordering': "['order']", 'object_name': 'ClockTown'},
        ...
        'cms_helper.menuimage': {
            'Meta': {'object_name': 'MenuImage'},
            'alt': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']"}),
            'menu_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sitetree.TreeItem']"}),
        ...
        'sitetree.treeitem': {
            ...
            'hint_en': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'hint_ru': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
