...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Params'
        db.create_table('cms_helper_params', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('value', self.gf('django.db.models.fields.TextField')()),
            ('value_ru', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('value_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('hint', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('cms_helper', ['Params'])


    def backwards(self, orm):
        # Deleting model 'Params'
        db.delete_table('cms_helper_params')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 1, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cms_helper.params': {
            ...
            'value_ru': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
