...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClockTown.town_en'
        db.add_column('cms_helper_clocktown', 'town_en',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClockTown.town_ru'
        db.add_column('cms_helper_clocktown', 'town_ru',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClockTown.town_en'
        db.delete_column('cms_helper_clocktown', 'town_en')

        # Deleting field 'ClockTown.town_ru'
        db.delete_column('cms_helper_clocktown', 'town_ru')
