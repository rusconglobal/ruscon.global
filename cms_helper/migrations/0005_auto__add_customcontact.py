...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_customcontact', (
            ...
            ('name_label', self.gf('django.db.models.fields.CharField')(default=u'Your name', max_length=100)),
            ('phone_label', self.gf('django.db.models.fields.CharField')(default=u'Phone', max_length=30)),
            ('town_label', self.gf('django.db.models.fields.CharField')(default=u'Town', max_length=30)),
        ))
        db.send_create_signal('cms_helper', ['CustomContact'])


    def backwards(self, orm):
        # Deleting model 'CustomContact'
        db.delete_table('cmsplugin_customcontact')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 24, 0, 0)'}),
